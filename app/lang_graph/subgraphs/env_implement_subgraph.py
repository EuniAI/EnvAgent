...
class EnvImplementSubgraph:
    def __init__(
        ...
        env_implement_file_context_provider_node = EnvImplementFileContextProviderNode(
            advanced_model, kg, neo4j_driver, max_token_per_neo4j_result, container.project_path
        )
        env_implement_file_context_provider_tools = ToolNode(
            tools=env_implement_file_context_provider_node.tools,
            name="context_provider_tools",
            messages_key="context_provider_messages",
        )

        env_implement_file_context_extraction_node = EnvImplementFileContextExtractionNode(advanced_model, container.project_path)
        env_implement_reset_context_provider_messages_node = ResetMessagesNode("context_provider_messages")
        env_implement_file_context_refine_node = EnvImplementFileContextRefineNode(advanced_model, kg, container.project_path)
        #########################################################
        ...
        # workflow.add_node("env_implement_file_context_retrieval_subgraph_node", env_implement_file_context_retrieval_subgraph_node)
        #########################################################

        workflow.add_node("env_implement_file_context_provider_node", env_implement_file_context_provider_node)
        workflow.add_node("env_implement_file_context_provider_tools", env_implement_file_context_provider_tools)
        workflow.add_node("env_implement_file_context_extraction_node", env_implement_file_context_extraction_node)
        workflow.add_node(
            "env_implement_reset_context_provider_messages_node", env_implement_reset_context_provider_messages_node
        )
        workflow.add_node("env_implement_file_context_refine_node", env_implement_file_context_refine_node)
        ...
        # workflow.add_edge("env_implement_file_context_message_node", "env_implement_file_context_retrieval_subgraph_node")
        # workflow.add_edge("env_implement_file_context_retrieval_subgraph_node", "env_implement_write_message_node")

        #########################################################
        workflow.add_edge("env_implement_file_context_message_node", "env_implement_file_context_provider_node")
        workflow.add_conditional_edges(
            "env_implement_file_context_provider_node",
            functools.partial(tools_condition, messages_key="context_provider_messages"),
            {"tools": "env_implement_file_context_provider_tools", END: "env_implement_file_context_extraction_node"},
        )
        workflow.add_edge("env_implement_file_context_provider_tools", "env_implement_file_context_provider_node")
        workflow.add_edge("env_implement_file_context_extraction_node", "env_implement_reset_context_provider_messages_node")
        workflow.add_edge("env_implement_reset_context_provider_messages_node", "env_implement_file_context_refine_node")

        # If refined_query is non-empty, loop back to provider; else terminate
        workflow.add_conditional_edges(
            "env_implement_file_context_refine_node",
            lambda state: bool(state["refined_query"]),
            {True: "env_implement_file_context_provider_node", False: "env_implement_write_message_node"},
        )
        #########################################################
    ...
    def invoke(
        ...
        config = {"recursion_limit": input_state['max_refined_query_loop'] * 40}
